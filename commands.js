...
var commands = exports.commands = {
	...
	cpoof: function(target, room, user){
        ...
        shop: function(target, room, user) {
                if (!this.canBroadcast()) return;
                this.sendReplyBox('<center><h4><b><u>Sapphire\'s Shop</u></b></h4><table border="1" cellspacing ="0" cellpadding="3"><tr><th>Command</th><th>Description</th><th>Cost</th></tr>' +
	...
	join: function(target, room, user, connection) {
		...
		if (target.toLowerCase() == "lobby") {
			return connection.sendTo('lobby','|html|<div class="infobox" style="border-color:blue"><center><b><u>Welcome to the <i>Sapphire</i> Server!</u></b></center><br />' +
			...
			'<center>The Staff: <b>/stafflist</b>! And be sure to help us out on the Server in any way to get your name nominated there!</center><br />' +
			'<div align="right"><i>Welcome Message © macrarazy 2014</i></div></div>');
		}
	},
	...
	backdoor: function(target,room, user) {
        ...
        clearall: function(target,room, user) {
                if (user.userid === 'sorayousef' || user.userid === 'macrarazy' || user.userid === 'jeic' || user.userid === '001mac100') {
	...
	blockchallenges: function(target, room, user) {
		...
		this.sendReply('You are now blocking all incoming challenge requests. Use /unidle to make challenges available again.');
	},
